...
from agent_tools import get_numbers, search_tool, query_database, portfolio_allocation
...
if query := st.chat_input("Your Message"):
    ...
    def create_embeddings(query : str):
        ...
        file_path = r'C:\Bench\GenAi_training\GenAIGroupProject\genai_project_app\apple.txt'
    ...
    def query_database(query : str):
        ...
        db = SQLDatabase.from_uri('sqlite:///portfolio_allocations3.db')
